...
-- NATURAL JOIN can lead to unexpected results if column names are not exactly the same across tables, as it automatically joins on columns with identical names.