...
union(parent, 0, 1)
print("Parent after union(0,1):", parent)  # e.g., [0,0,2,3]
print("Find(1):", find(parent, 1))         # Output: 0

union(parent, 1, 2)
print("Parent after union(1,2):", parent)  # e.g., [0,0,0,3]
print("Find(2):", find(parent, 2))         # Output: 0
