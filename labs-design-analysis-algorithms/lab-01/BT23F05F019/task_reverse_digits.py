...
print("Recursive reverse:", reverse_digits_recursive(test_number))
print("Iterative reverse:", reverse_digits_iterative(test_number))

# Test with another number
test_number2 = 56789
print("\nOriginal number:", test_number2)
print("Recursive reverse:", reverse_digits_recursive(test_number2))
print("Iterative reverse:", reverse_digits_iterative(test_number2))
