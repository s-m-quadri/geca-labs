...
<<<<<<<< HEAD:labs-design-analysis-algorithms/lab-01/BT23F05F023/task_sum_even_numbers.py
    if n <= 1:
        return 0
    if n % 2 == 0:
...
print(sum_even_iterative(10))
>>>>>>>> sub-lab-daa-04:labs-design-analysis-algorithms/lab-04/BT23F05F019/task_sum_even_numbers.py
