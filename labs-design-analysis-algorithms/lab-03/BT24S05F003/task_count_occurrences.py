...
# Count how many times a target appears in a sorted array using binary search logic.
...
arr1 = [1, 2, 2, 2, 3, 4]
target1 = 2
print(f"Count of {target1}: {count_occurrences(arr1, target1)}")  # Output: 3

arr2 = [5, 5, 5, 5, 5]
target2 = 5
print(f"Count of {target2}: {count_occurrences(arr2, target2)}")  # Output: 5

arr3 = [1, 3, 5, 7, 9]
target3 = 4
print(f"Count of {target3}: {count_occurrences(arr3, target3)}")  # Output: 0
